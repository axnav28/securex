...
import { ArrowDownRight, ArrowUpRight, ChevronRight, CircleAlert, Clock3, ExternalLink, ShieldCheck, Target, Waypoints } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const [on] = useState(controls[0].on);
  ...
  return <div className="content dashboard-page">
    <div className="dashboard-topline"><div className="page-heading-block"><PageHeader eyebrow="Executive command centre · Live exposure" title="Good morning, Arnav." sub={`${org} · refreshed just now`} /></div><div className="dashboard-actions"><span className="live-pill"><i /> Live model</span><Link href="/reports" className="ghost"><ExternalLink size={14} /> Export report</Link></div></div>
